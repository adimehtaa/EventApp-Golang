...
func (m *AttendeeModel) Insert(attendee *Attendees) (*Attendees, error) {
...
func (m AttendeeModel) GetByEventAndAttendee(eventId int, userId int) (*Attendees, error) {
	ctx, cancel := context.WithTimeout(context.Background(), time.Second*3)
	defer cancel()
...
func (m *AttendeeModel) GetAttendeeByEvent(eventID int) ([]*Users, error) {
...
func (m *AttendeeModel) GetEventByAttendee(attendeeId int) ([]*Events, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second)
	defer cancel()
